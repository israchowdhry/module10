...
################################################################################
    ...
    def test_required_fields(self):
        ...
        for inc in json_response:
            # compares incident keys to required fields
            self.assertEqual(set(inc.keys()), set(required_fields))
################################################################################
    ...
    def test_escalators(self):
        ...
        for inc in json_response:
            self.assertEqual(inc["UnitType"].upper(), "ESCALATOR")
...
################################################################################
    ...
    def test_elevators(self):
        ...
        for inc in json_response:
            self.assertEqual(inc["UnitType"].upper(), "ELEVATOR")
